...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Audit.ai" },
      { name: "description", content: "AI-powered product audits" },
      { name: "author", content: "Audit.ai" },
      { property: "og:title", content: "Audit.ai" },
      { property: "og:description", content: "AI-powered product audits" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Audit.ai" },
      { name: "twitter:description", content: "AI-powered product audits" },
